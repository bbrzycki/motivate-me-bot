...
def full_credits_width(img,
                       ...
                       footer_font_file='AppleGothic.ttf',
                       min_font_size=14):
    image_cred_width = credit_width(img,
                                    image_name,
                                    image_screen_name,
                                    footer_font_file=footer_font_file,
                                    min_font_size=min_font_size)
    quote_cred_width = credit_width(img,
                                    quote_name,
                                    quote_screen_name,
                                    footer_font_file=footer_font_file,
                                    min_font_size=min_font_size)
